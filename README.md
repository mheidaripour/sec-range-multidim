...
The project involves conducting experiments related to the paper [Organizing Records for Retrieval in Multi-Dimensional Range Searchable Encryption][paper] published in SECRYPT2024 conference.
